...
Not everything in the `@h4shed` package hub is a `tool-*` wrapper — standalone products (e.g. `@h4shed/rock-hardened`, `dynagraph`) get the same registry treatment but carry extra fields in `registry/tools.registry.json`:
